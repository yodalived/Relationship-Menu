...
export function getItemSpanClasses(iconType: string | null | undefined) {
  ...
  switch(iconType) {
    ...
    case 'maybe':
      return `${baseClasses} [background-image:linear-gradient(-100deg,rgba(233,180,103,0.2),rgba(255,195,108,0.5)_95%,rgba(233,180,103,0.1))] dark:[background-image:linear-gradient(-100deg,rgba(245,158,11,0.3),rgba(245,158,11,0.7)_95%,rgba(245,158,11,0.3))]`;
    case 'off-limit':
