...
export default function Header() {
  ...
  return (
    <header className="bg-[#94BCC2] dark:bg-[rgba(45,85,95,0.85)] text-white font-bold text-xl sticky top-0 z-10 shadow-md">
      <div className={`flex flex-row items-center ${isEditorPage ? 'justify-between' : 'justify-center'} text-left px-6 sm:px-8 md:px-9 xl:px-20 py-2.5 w-full sm:text-center sm:justify-center sm:flex-col`}>
